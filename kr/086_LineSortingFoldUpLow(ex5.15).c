...
int main(int argc, char *argv[])
{
	...
	if ((argc > 1 && (strcmp(argv[1], "-n") == 0)) || (argc > 2 && ((strcmp(argv[1], "-n") == 0) || (strcmp(argv[2], "-n") == 0)))
							|| (argc > 3 && ((strcmp(argv[1], "-n") == 0) || (strcmp(argv[2], "-n") == 0) || (strcmp(argv[3], "-n") == 0))))
		numeric = 1;
	
	if ((argc > 1 && (strcmp(argv[1], "-r") == 0)) || (argc > 2 && ((strcmp(argv[1], "-r") == 0) || (strcmp(argv[2], "-r") == 0)))
							|| (argc > 3 && ((strcmp(argv[1], "-r") == 0) || (strcmp(argv[2], "-r") == 0) || (strcmp(argv[3], "-r") == 0))))
		reverse = 1;
		
	if ((argc > 1 && (strcmp(argv[1], "-f") == 0)) || (argc > 2 && ((strcmp(argv[1], "-f") == 0) || (strcmp(argv[2], "-f") == 0)))
							|| (argc > 3 && ((strcmp(argv[1], "-f") == 0) || (strcmp(argv[2], "-f") == 0) || (strcmp(argv[3], "-f") == 0))))
		reverse = 2; //this is the -f flag really, cant be asked to change names
