/*
K&R Ex 1-23, p.34.
Write a program to remove all comments from C program
Don't forget to andle quoted strings and character constants properly. C comments do not nest
<this may still be ignoring the character constants but at this stage i know little of them to code
adequately>
*/
#include<stdio.h>
